...
parser.add_argument('--backbone', type=str, default='efficient_face')
...
args.target_layers = [eval(num) for num in args.target_layers]
file_name = utils.get_cur_file_name(__file__)
cfg = utils.set_version(cfg, version=file_name, suffix='debug', tmp=args.tmp, args=args)
