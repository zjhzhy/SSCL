...
from DataLoader.ferplus_argument import get_dataloader
import json
...
def main():
    ...
    if 'alpha' in args.tune:
        ...
        """nni.variable(nni.quniform(0.0,2.0,0.2), name=args.alpha)"""
    ...
    if args.test_mode == 'valid':
        _print('using valid set')
        val_loader = val_loader
    elif args.test_mode == 'test':
        val_loader = test_loader
        _print('using test set')
    _print('use valild set as validation.')
