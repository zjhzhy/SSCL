...
def main():
    ...
    parser.add_argument('--backbone', type=str, default='ms1m_res18')
    ...
    logsuffix = ''
    print('tuning distance:{}'.format(args.alpha))
    """nni.variable(nni.choice('kl','js'), name=args.distance)"""
    args.distance = args.distance
    logsuffix = logsuffix + 'distance{}'.format(args.distance)
