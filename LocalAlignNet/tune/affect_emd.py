...
sys.path.append(('/home/lab303/yx/database/affectnet'))
...
from DataLoader.affect_argument import get_dataloader
import json
...
def main():
    ...
    parser.add_argument('--des', type=str, default=description) #描述
    ...
    logsuffix += '_' + str(nni.get_sequence_id())
    cfg = Config.cfg   #
    ...
    scheduler = lr_scheduler.MultiStepLR(optimizer, milestones=[20, 30], gamma=0.1) #动态
    # load data
...
if __name__ == '__main__':
    ...
    logger = logging.getLogger('DEMSearch_AutoML_affect')
    try:
        main()
