...
sys.path.append('/home/b3432/Code/experiment/zhujunhao/workspace/MoPro/LocalAlignNet')
import torch
import torch.nn as nn
from LocalAlignNet.models.LightFace.modulator import Modulator
...
class EfficientFaceEncoder(nn.Module):

    def __init__(self, stages_repeats, stages_out_channels, num_classes=7):
        super(EfficientFaceEncoder, self).__init__()
...
def efficient_face_encoder():
    model = EfficientFaceEncoder([4, 8, 4], [29, 116, 232, 464, 1024])
    ckpt = '/home/b3432/Code/experiment/zhujunhao/workspace/EfficientFace/pretrained_model/Pretrained_EfficientFace.tar'
    pretrained = torch.load(ckpt)
...
if __name__ == '__main__':
    ...
    model = efficient_face().cuda()
    summary(model, input_size=(3, 224, 224), batch_size=10, device='cuda')
