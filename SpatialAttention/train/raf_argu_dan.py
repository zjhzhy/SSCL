...
from SpatialAttention.models.resnet import resnet18_msceleb
...
def run_training():
    ...
    criterion_al = AffinityLoss(device)
    params = list(model.parameters()) + list(criterion_al.parameters())
    ...
    for epoch in tqdm(range(1, args.epochs + 1)):
        ...
        for (imgs, targets) in train_loader:
            ...
            loss = criterion_cls(out, targets) + 1 * criterion_al(feat, targets)
