...
from SpatialAttention.attention.SEAttention import SEAttention
...
class SeResNet(nn.Module):
    ...
    def __init__(self, layers, export_layer=4, in_channel=3, width=1, num_class=1000):
        ...
        self.layer1 = self._make_layer(SEBasicBlock, self.base, layers[0], stride=1)
        self.layer2 = self._make_layer(SEBasicBlock, self.base * 2, layers[1], stride=2)
        self.layer3 = self._make_layer(SEBasicBlock, self.base * 4, layers[2], stride=2)
        self.layer4 = self._make_layer(SEBasicBlock, self.base * 8, layers[3], stride=2)
        self.avgpool = nn.AvgPool2d(7, stride=1)
        self.classifier = nn.Linear(self.base * 8 * SEBasicBlock.expansion, num_class)
...
def se_resnet18(num_classes=1_000):
    ...
    """
    model = SeResNet([2, 2, 2, 2], num_class=num_classes)
