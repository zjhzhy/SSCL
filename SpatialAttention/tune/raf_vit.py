...
import torch
import os
from SpatialAttention.models.resnet import resnet18_cbam34, resnet18_cbam4, resvit, resprevit384
import argparse
import utils
import pandas as pd
...
def main():
    ...
    best_acc_epoch = 0
    # load models
    model = resprevit384(args).to(cfg.device)
