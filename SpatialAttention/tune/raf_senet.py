...
import torch
import os
from SpatialAttention.models.SeResnet import se_resnet18
import argparse
import utils
import pandas as pd
...
def main():
    ...
    '''nni.variable(nni.choice(0.01, 0.1), name=args.lr)'''
    args.lr = args.lr
    logsuffix = ''
    ...
    best_acc_epoch = 0
    # load models
    model = se_resnet18(num_classes=args.num_classes).to(cfg.device)
